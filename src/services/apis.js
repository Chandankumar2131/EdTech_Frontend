...
export const courseEndpoints = {
  GET_ALL_COURSE_API: BASE_URL + "/course/course/get-all",
  COURSE_DETAILS_API: BASE_URL + "/course/course/details",
  EDIT_COURSE_API: BASE_URL + "/course/course/edit",
  COURSE_CATEGORIES_API: BASE_URL + "/course/category/get-all",
  ...
  UPDATE_SECTION_API: BASE_URL + "/course/section/update",
  UPDATE_SUBSECTION_API: BASE_URL + "/course/subsection/update",
  GET_ALL_INSTRUCTOR_COURSES_API: BASE_URL + "/course/getInstructorCourses",
  DELETE_SECTION_API: BASE_URL + "/course/section/delete",
  DELETE_SUBSECTION_API: BASE_URL + "/course/subsection/delete",
...
export const categories = {
  CATEGORIES_API: BASE_URL + "/course/category/get-all",
}

// CATALOG PAGE DATA
export const catalogData = {
  CATALOGPAGEDATA_API: BASE_URL + "/course/category/getCategoryPageDetails",
}
// CONTACT-US API
