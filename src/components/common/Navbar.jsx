...
const Navbar = () => {
    ...
    return (
        <nav className={`z-[10] flex h-14 w-full items-center justify-center border-b border-gray-700 text-white translate-y-0 transition-all ${showNavbar} `}>
                            ...
                            <li key={index}>
                                {
                                    link.title === "Catalog" ? (
                                        ...
                                        <Link to={link?.path}>
                                            <p className={`${matchRoute(link?.path) ? "bg-yellow-200 text-black" : "text-gray-200"} rounded-xl p-1 px-3 `}>
                                                {link.title}
                                            </p>
                                        </Link>)
                                }
