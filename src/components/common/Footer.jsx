...
const Footer = () => {
  return (
    <div className="bg-gray-900 mx-7">
      <div className="flex lg:flex-row gap-8 items-center justify-between w-11/12 max-w-[1200px] text-gray-400 leading-6 mx-auto relative py-14">
        <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-gray-700">
          ...
          <div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-gray-700 pl-3 lg:pr-5 gap-3">
            <div className="w-[30%] flex flex-col gap-3 lg:w-[30%] mb-7 lg:pl-0">
              ...
              <h1 className="text-gray-100 font-semibold text-[16px]">Company</h1>
              <div className="flex flex-col gap-2">
                {["About", "Careers", "Affiliates"].map((ele, i) => {
                  return (
                    <div
                      key={i}
                      className="text-[14px] cursor-pointer hover:text-gray-100 transition-all duration-200"
                    >
            ...
            <div className="w-[48%] lg:w-[30%] mb-7 lg:pl-0">
              <h1 className="text-gray-100 font-semibold text-[16px]">Resources</h1>
              ...
              <h1 className="text-gray-100 font-semibold text-[16px] mt-7">Support</h1>
              <div className="text-[14px] cursor-pointer hover:text-gray-100 transition-all duration-200 mt-2">
            ...
            {/* Plans */}
            <div className="w-[48%] lg:w-[30%] mb-7 lg:pl-0">
              <h1 className="text-gray-100 font-semibold text-[16px]">Plans</h1>
              <div className="flex flex-col gap-2 mt-2">
                {Plans.map((ele, index) => {
                  return (
                    <div
              ...
              <h1 className="text-gray-100 font-semibold text-[16px] mt-7">Community</h1>
              <div className="flex flex-col gap-2 mt-2">
            ...
            {FooterLink2.map((ele, i) => {
              return (
                <div key={i} className="w-[35%] lg:w-[30%] mb-7 lg:pl-0">
                  <h1 className="text-gray-100 font-semibold text-[16px]">{ele.title}</h1>
                  <div className="flex flex-col gap-2 mt-2">
      ...
      {/* bottom footer */}
      <div className="flex flex-row items-center justify-between w-11/12 max-w-[1200px] text-gray-400 mx-auto pb-14 text-sm">
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
            ...
            {BottomFooter.map((ele, ind) => {
              return (
                <div
                  key={ind}
                  className={` ${
                    BottomFooter.length - 1 === ind ? "" : "border-r border-gray-600 "
                  } px-3 text-gray-500 cursor-pointer hover:text-gray-400 transition-all duration-200`}
                >
          ...
          <div className="text-center flex flex-col sm:flex-row">
            <div className="flex">
              ...
              <Link
                to="https://github.com/Chandankumar2131"
                target="__blank"
                className="text-gray-400 hover:underline mr-1"
              >
                Chandan Kumar
              </Link>
            </div>
          ...
          <div className="flex items-center">
            <a
              ...
              className="text-white p-3 hover:bg-gray-700 rounded-full duration-300"
              target="_blank"
