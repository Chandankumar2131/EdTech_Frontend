  ...
  return (
    <div className="flex w-full items-start gap-x-6">
      ...
      <div className="flex flex-1 flex-col">
        <h1 className="mb-14 text-3xl font-medium text-gray-100 font-boogaloo text-center lg:text-left">
          Add Course
        </h1>
      ...
      <div className="sticky top-10 hidden lg:block max-w-[400px] flex-1 rounded-md border-[1px] border-gray-700 bg-gray-800 p-6 ">
        ...
        <ul className="ml-5 list-item list-disc space-y-4 text-xs text-gray-100">
