      ...
      >
        {course?.courseContent?.map((section) => (
          <details key={section._id} open>
            <summary className="flex cursor-pointer items-center justify-between border-b-2 border-gray-600 py-2">
              <div className="flex items-center gap-3">
                <RxDropdownMenu className="text-2xl text-gray-100" />
                <p className="font-semibold text-gray-100">{section.sectionName}</p>
              </div>
            ...
            <div className="px-6 pb-4">
              {section.subSection.map((data) => (
                <div
                  ...
                  className="flex cursor-pointer items-center justify-between gap-3 border-b-2 border-gray-600 py-2"
                >
                  <div className="flex items-center gap-3">
                    <RxDropdownMenu className="text-2xl text-gray-100" />
                    <p className="font-semibold text-gray-100">{data.title}</p>
                  </div>
              ...
              <button
                ...
                className="mt-3 flex items-center gap-1 text-yellow-400"
              >
