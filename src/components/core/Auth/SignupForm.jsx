  ...
  return (
    <div>
      ...
      <form onSubmit={handleOnSubmit} className="flex w-full flex-col gap-y-4">
        <div className="flex gap-x-4">
          ...
          <label>
            ...
            <input
              ...
              className="w-full rounded-[0.5rem] bg-gray-700 p-[12px] text-[#F1F2FF] outline-none"
            />
          </label>
        ...
        <div className="flex gap-x-4">
          ...
          <label className="relative">
            ...
            <input
              ...
              style={{ boxShadow: "inset 0px -1px 0px rgba(255, 255, 255, 0.18)" }}
              className="w-full rounded-[0.5rem] bg-gray-700 p-[12px] pr-10 text-[#F1F2FF] outline-none"
            />
            <span
        ...
        <button
          type="submit"
          className="mt-6 rounded-[8px] bg-[#E7C009] py-[8px] px-[12px] font-medium text-[#585D69]"
        >
          Create Account
        </button>
      </form>
